...
int CDevice::CreateConstBuffer()
{
	...
	m_arrCB[(UINT)CB_TYPE::BackgroundMgt_DATA] = new CConstBuffer(CB_TYPE::BackgroundMgt_DATA);
	m_arrCB[(UINT)CB_TYPE::BackgroundMgt_DATA]->Create(sizeof(tGlobalData), 1);
