...
void CAssetMgr::CreateDefaultGraphicsShader()
{
	...
	// =================================
	// BackgroundMagentaShader
	// =================================
	pShader = new CGraphicsShader;
	pShader->CreateVertexShader(L"shader\\BackgroundMagenta.fx", "VS_Std2D_BackgroundM");
	pShader->CreatePixelShader(L"shader\\BackgroundMagenta.fx", "PS_Std2D_BackgroundM");
	...
	AddAsset(L"BackgroundMagentaShader", pShader.Get());
